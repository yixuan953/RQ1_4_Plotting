...
output_dir = "/lustre/nobackup/WUR/ESG/zhou111/4_RQ1_Analysis_Results/V2_Demo_Plots/Fig1/1c"
data_dir = "/lustre/nobackup/WUR/ESG/zhou111/2_RQ1_Data/2_StudyArea"

units = ["Irrigation water amount ($m^3$)", "ktons N", "ktons P"]
cat_colors = {"Wheat": "#B379B4", "Rice": "#4D97CD", "Maize": "#eb8b39",  "Soybean": "#72b285"}
...
plt.savefig(os.path.join(output_dir, "Fig1c.png"), bbox_inches='tight', dpi=300)