...
for basin in Studyareas:
    ...
    ax.barh(y - width, df['N & P'] * 100, width, label='N & P', color=colors[0], alpha = 0.7, edgecolor='grey')
    ax.barh(y, df['P'] * 100, width, label='P', color=colors[1], alpha = 0.7, edgecolor='grey')
    ax.barh(y + width, df['N'] * 100, width, label='N', color=colors[2], alpha = 0.7, edgecolor='grey')
