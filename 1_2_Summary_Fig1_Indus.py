...
Croptypes =  ["winterwheat", "maize", "mainrice"] # ["winterwheat", "maize", "mainrice", "secondrice", "soybean"]
...
for basin in Studyarea:
    ...
    for crop in Croptypes:
        ...
        vmin = 0
        vmax = 1000000000
        fig1 = plt.figure(figsize=(12, 6)) # Indus
        ...
        vmin = 0
        vmax = 5
        fig2 = plt.figure(figsize=(12, 6)) # Indus
        ...
        vmin = 0
        vmax = 0.2
        fig3 = plt.figure(figsize=(12, 6)) # Indus
        ...
        vmin = 0
        vmax = 1000
        fig4 = plt.figure(figsize=(12, 6)) # Indus
