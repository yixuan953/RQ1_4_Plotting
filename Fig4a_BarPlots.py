...
def plot_1x4_nutrient(data_dict, crit_dict, nutrient_label, filename):
    ...
    for i, basin in enumerate(Studyareas):
        ...
        for cat in FinalCategories:
            ...
            ax.bar(0, v_act, bottom=b_actual, width=bar_width, color=crop_colors[cat], edgecolor='black', linewidth=1)
            ax.bar(1, v_cri, bottom=b_crit, width=bar_width, color=crop_colors[cat], edgecolor='black', linewidth=1)
