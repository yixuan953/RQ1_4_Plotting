...
fig_base_dir = "/lustre/nobackup/WUR/ESG/zhou111/4_RQ1_Analysis_Results/V3_Demo_Plots/Fig2_Sim_Yield_Loss"
...
def GetSimSummary(file_name):
    ...
    return (mask, Rainfed_Yield, Irrigated_Yield, Total_Production, 
            N_runoff_Rainfed, N_runoff_Irrigated, N_runoff,  
            P_runoff_Rainfed, P_runoff_Irrigated, P_runoff)
...
def plot_boundaries(file_name, data_dir, fig_path, basin):
    ...
    cmaps = ['YlGn']*3 + ['RdPu']*3 + [custom_phosphorus_cmap]*3
    ...
    fig, axes = plt.subplots(nrows=9, ncols=1, figsize=(30, 150),
...
for basin in Studyareas:
    for crop in InputCrops:
        ...
        data_vars = {
            "Rainfed_yield": outputs[1],
            "Irrigated_yield": outputs[2],
            "Total_production": outputs[3],
            "N_Runoff_Rainfed_kg_ha": outputs[4],
            "N_Runoff_Irrigated_kg_ha": outputs[5],
            "N_Runoff_ktons": outputs[6],
            "P_Runoff_Rainfed_kg_ha": outputs[7],
            "P_Runoff_Irrigated_kg_ha": outputs[8],
            "P_Runoff_ktons": outputs[9],
