...
# Irrigated_fert_input_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/4_Fertilization_Red/4_1a_Reduced_Fert_RespectN/Irrigated/Respect_N_50"
# Rainfed_fert_input_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/4_Fertilization_Red/4_1a_Reduced_Fert_RespectN/Rainfed/Respect_N_50"

# Irrigated_fert_input_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/4_Fertilization_Red/4_1b_Reduced_Fert_RespectP/Irrigated/Respect_P_50"
# Rainfed_fert_input_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/4_Fertilization_Red/4_1b_Reduced_Fert_RespectP/Rainfed/Respect_P_50"

Irrigated_fert_input_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/4_Fertilization_Red/4_1c_Reduced_Fert_RespectNP/Irrigated/Respect_NP_40"
Rainfed_fert_input_dir = "/lustre/nobackup/WUR/ESG/zhou111/3_RQ1_Model_Outputs/3_Scenarios/4_Fertilization_Red/4_1c_Reduced_Fert_RespectNP/Rainfed/Respect_NP_40"


output_dir = "/lustre/nobackup/WUR/ESG/zhou111/4_RQ1_Analysis_Results/V5_Statistics/Extended_Stat/1_Fert_Rate/2_Respect_NP_40"
...
def GetFertMass(nc_path, crop_fn, area_mask):
    ...
    with xr.open_dataset(nc_path) as ds:
        ...
        if crop_fn == "Secondrice":
            ...
            crop_fn2 = crop_fn
        m_ni = (ds_2015[f"{crop_fn2}_Total_inorg_N_application_rate"] * area_mask * mask).sum().values * 1e-6
        m_nm = (ds_2015[f"{crop_fn2}_Manure_N_application_rate"] * area_mask * mask).sum().values * 1e-6 
        m_pi = (ds_2015[f"{crop_fn2}_P_application_rate"] * area_mask * mask).sum().values * 1e-6
        m_pm = (ds_2015[f"{crop_fn2}_Manure_P_application_rate"] * area_mask * mask).sum().values * 1e-6
...
for basin in STUDY_AREAS:
    ...
    if basin_results:
        pd.DataFrame(basin_results).to_csv(os.path.join(output_dir, f"{basin}_Fert_RespectNP_Summary.csv"), index=False)
