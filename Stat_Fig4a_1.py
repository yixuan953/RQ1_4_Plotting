...
output_dir = "/lustre/nobackup/WUR/ESG/zhou111/4_RQ1_Analysis_Results/V4_Statistics/2_Simulated_Yield_Runoff"
...
row_labels = [
    ...
    "Avg_N_uptake_rainfed", "Avg_N_uptake_irrigated", "Avg_N_uptake_total",
