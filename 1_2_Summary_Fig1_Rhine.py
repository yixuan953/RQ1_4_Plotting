...
Studyarea =  ["Rhine"] # ["Indus", "LaPlata", "Yangtze", "Rhine"]
Croptypes =  ["winterwheat", "maize"] # ["winterwheat", "maize", "mainrice", "secondrice", "soybean"]
...
for basin in Studyarea:
    ...
    for crop in Croptypes:
        ...
        input_file = os.path.join(input_dir, f"{basin}_{crop}_summary_M3_baseline.nc") # Basline scenario
